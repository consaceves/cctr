...
user_profile = {'age': 0, 'gender': '', 'pscore': 0, 'walking': 0, 'biking': 0, 'swimming': 0, 'elliptical': 0,
                ...
                'gardening': 0, 'calf raises': 0, 'leg raises': 0, 'arm stretch': 0, 'hip stretch': 0, 'arm stretch': 0,
                'leg stretch': 0, 'hip stretch': 0, 'glute bridges': 0}
...
def get_recommended_workout(recommended_exercises):
    ...
    for exercise in recommended_exercises:
        ...
        if exercise in rep_based_exercises:
            result[exercise] = " 3 sets of " + str(intensity[0])
        else:
            result[exercise] = str(intensity[1]) + " minutes"
    return result
